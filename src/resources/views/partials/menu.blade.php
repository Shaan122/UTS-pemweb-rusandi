    ...
    <ul class="c-sidebar-nav">
        ...
        @can('fn_b_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/tables*") ? "c-show" : "" }} {{ request()->is("admin/bookings*") ? "c-show" : "" }} {{ request()->is("admin/prices*") ? "c-show" : "" }} {{ request()->is("admin/products*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('datapembayaran_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.datapembayarans.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/datapembayarans") || request()->is("admin/datapembayarans/*") ? "c-active" : "" }}">
                                <i class="fa-fw fab fa-product-hunt c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.datapembayaran.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
